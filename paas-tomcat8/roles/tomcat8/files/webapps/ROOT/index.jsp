...
<title>Tomcat 8 Welcome Page</title>
<style type="text/css">
        /*<![CDATA[*/
        body {
...
<body>
        ...
        <div class="content">
                ...
                <ul>
                        ...
                        <li>Environment variables (e.g. JAVA_OPTS) are defined in <span class="code">/etc/sysconfig/tomcat8.conf</span></li>
